...
var subnetName = 'adflab-${randomString}-subnet'
var virtualNetworkName = 'adflab-${randomString}-vnet'
var networkSecurityGroupName = 'adflab-${randomString}-nsg'
var publicIpAddressName = 'adflab-${randomString}-pub-ip'
var virtualMachineComputerName = 'adflab${randomString}com'
var sqlVirtualMachineName = 'adflab-${randomString}-sqlvm'
...
resource dataDiskResources_name 'Microsoft.Compute/disks@2020-12-01' = {
  name: 'adflab-${randomString}_DataDisk'
  location: location
  sku: {
    name: 'Premium_LRS'
  }
